...
var FileUploadApi = (function () {
    ...
    FileUploadApi.prototype.getBlobSharedAccessSignature = function (blobName, auth, done) {
        ...
        if (!auth)
            throw new ReferenceError('auth cannot be \'' + auth + '\'');
        ...
        var path = azure_iot_common_1.endpoint.devicePath(this.deviceId) + '/files/' + blobName + azure_iot_common_1.endpoint.versionQueryString();
    ...
    FileUploadApi.prototype.notifyUploadComplete = function (correlationId, auth, uploadResult, done) {
        ...
        var path = azure_iot_common_1.endpoint.devicePath(this.deviceId) + '/files/notifications/' + encodeURIComponent(correlationId) + azure_iot_common_1.endpoint.versionQueryString();
